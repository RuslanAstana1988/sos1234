...
let str = `
*ミ💖 ПРИВЕТ✨${taguser}✨, ЗДЕСЬ ВСЕ КОМАНДЫ БОТА ПИЗДЮКА 💖彡*
...
° ඬ⃟🎖️ _${usedPrefix}ПИЗДЮК*<текст>*_
...
handler.command = /^(ааа|menú|memu|memú|info|comandos|allmenu|2help|menu1.2|ayuda|commands|commandos|cmd)$/i
handler.exp = 50
handler.fail = null

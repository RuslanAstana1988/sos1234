...
if (!chat.isBanned && chat.audios && m.text.match(/(Ахренел|ахренел)/gi)) {
let vn = './media/грейся.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (!chat.isBanned && chat.audios && m.text.match(/(Что они творят|что они творят)/gi)) {
let vn = './media/любовное.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (!chat.isBanned && chat.audios && m.text.match(/(Ты меня заразил|ты меня заразил)/gi)) {
let vn = './media/заразил.mp3' 
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (!chat.isBanned && chat.audios && m.text.match(/(Расскажи о себе|расскажи о себе)/gi)) {
let vn = './media/немного.mp3' 
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (!chat.isBanned && chat.audios && m.text.match(/(От заразина|от заразина)/gi)) {
let vn = './media/помучить.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
if (!chat.isBanned && chat.audios && m.text.match(/(Я бы орден дал|я бы орден дал)/gi)) {
let vn = './media/орден.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (!chat.isBanned && chat.audios && m.text.match(/(Верю|верю)/gi)) {
let vn = './media/дичь.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (!chat.isBanned && chat.audios && m.text.match(/(Завтра посмотрим|завтра посмотрим)/gi)) {
let vn = './media/лишь.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (!chat.isBanned && chat.audios && m.text.match(/(Саша умничка|саша умничка)/gi)) {
let vn = './media/саша.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
if (!chat.isBanned && chat.audios && m.text.match(/(Прощаю|прощаю)/gi)) {
...
if (!chat.isBanned && chat.audios && m.text.match(/(Скиньте стики 18+|скиньте стики 18+)/gi)) {    
...
if (!chat.isBanned && chat.audios && m.text.match(/(Я орёл|я орёл|)/gi)) {    
let vn = './media/дятел'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}  
...
if (!chat.isBanned && chat.audios && m.text.match(/(Стикеры|стикеры)/gi)) {    
let vn = './media/hhh.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (!chat.isBanned && chat.audios && m.text.match(/(Накидайте сиков|накидайте сиков)/gi)) {    
let vn = './media/hhh.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
if (!chat.isBanned && chat.audios && m.text.match(/(Бурундучок|бурундучок)/gi)) {    
let vn = './media/diman.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
